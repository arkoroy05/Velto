...
const testimonials = [
  {
    quote:
      "The real-time code suggestions feel like having a senior engineer reviewing every line of code as you write. The accuracy of recommendations has improved our overall code quality and reduced review time significantly.",
  ...
  {
    quote:
      "Deploying with Pointer was not just simple, it felt seamless. We went from coding to seeing our changes live in minutes without worrying about build pipelines or configuration issues.",
